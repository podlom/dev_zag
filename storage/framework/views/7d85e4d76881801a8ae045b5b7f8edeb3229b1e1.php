...
<main>
    ...
    <section class="catalog">
        ...
        <div class="general-heading container">
            <h1 class="main-caption-l"><?php echo e($page[$type . '_title']); ?> <span v-if="query.page > 1" v-cloak> ➨ <?php echo e(__('main.страница')); ?> {{ query.page }}</span></h1>
            <div class="catalog__buttons-wrapper">
                ...
                <button class="filter-button js-filter" data-target="full-filter">
                    ...
                    <span class="filter-button__text"><?php echo e(__('main.Фильтрация')); ?></span>
                </button>
            </div>
        </div>
            ...
            <div class="catalog__main-wrapper">
                <div class="catalog-filter__form">
                    <label class="input__wrapper js-filter" data-target="filter">
                        <input type="text" class="main-input" :value="fullAddress" placeholder="<?php echo e(__('main.Вся Украина')); ?>" readonly="readonly">
                    ...
                    <label class="input__wrapper">
                        <input type="text" class="main-input main-input-filter" v-model="query.filters.search_value" placeholder="<?php echo e(__('forms.placeholders.КГ, адрес или компания')); ?>">
                    </label>
                ...
                <div class="catalog__filtration__wrapper js-filter-drop" data-target="full-filter">
                    <div class="catalog__filtration__container">
                        <h5 class="catalog__mobile-caption"><?php echo e(__('main.Фильтрация')); ?></h5>
                        <div class="catalog__filtration__header">
                            <?php if($category->id === 1 || $category->original_id === 1): ?>
                            <template v-for="(attribute, key) in filters.attributes">
                                <div class="wrapper" v-if="attribute.slug === 'type'">
                                    <h5 class="catalog__filtration__caption"><?php echo e(__('main.Тип недвижимости')); ?></h5>
                            ...
                            <div class="catalog__range-slider">
                                <h5 class="catalog__filtration__caption"><?php echo e(__('main.Диапазон цен')); ?> (грн/м2)</h5>
                                <div class="wrapper">
                                    <div class="range-slider">
                                        <vue-slider
                                        ref="slider"
                        ...
                        <div class="catalog__filtration__body js-catalog-more-item">
                            ...
                            <div class="catalog__filtration__body__wrapper catalog__filtration__body__wrapper-list">
                                <div class="catalog__checkbox-wrapper">
                                    <h5 class="catalog__filtration__caption"><?php echo e(__('main.Материал стен')); ?></h5>
                                    <ul class="catalog__filtration__list">
                                ...
                                <?php if($category->id === 1 || $category->original_id === 1): ?>
                                <div class="catalog__checkbox-wrapper">
                                    <h5 class="catalog__filtration__caption"><?php echo e(__('main.Материал крыши')); ?></h5>
                                    <ul class="catalog__filtration__list">
                        ...
                        <div class="catalog__filtration__footer">
                            ...
                            <button class="catalog__clear" @click="clearFilters()">
                                <span class="wrapper">
                                    ...
                                    <span class="text"><?php echo e(__('main.Сбросить')); ?></span>
                                </span>
                            </button>
    ...
    <?php if($page[$type . '_seo_text'] && (!request('page') || request('page') == 1)): ?>
    <section class="seo-block">
        <div class="seo-block__wrapper container">
            <h2 class="main-caption-l"><?php echo e($page[$type . '_seo_title']); ?></h2>
...
<script>
    ...
    var filters = <?php echo json_encode($filters, 15, 512) ?>;
    var selecterFilters = <?php echo json_encode($selected_filters, 15, 512) ?>;
    var sorts = <?php echo json_encode(__('sorts.products'), 15, 512) ?>;
    var rangeOptions = <?php echo json_encode($range_options, 15, 512) ?>;
    var regions = <?php echo json_encode($regions, 15, 512) ?>;
</script>
<script src="<?php echo e(url('js/catalog/catalog.js?v=' . $version)); ?>"></script>
<?php $__env->stopPush(); ?>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/zagorodnaz/dev.zagorodna.com/dev_app/resources/views/catalog/index.blade.php ENDPATH**/ ?>