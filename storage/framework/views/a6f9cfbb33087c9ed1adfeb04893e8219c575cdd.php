    ...
    <section class="breadcrumbs">
        <div class="breadcrumbs__wrapper">
            <div class="breadcrumbs__list">
                ...
                <a href="#" class="breadcrumbs__link" @click.prevent="query.category = null" v-cloak><?php echo e(__('main.Полезная информация')); ?></a>
    ...
    <section class="news">
        <div class="news__wrapper container">
            <div class="general-heading">
                <h1 class="main-caption-l" v-cloak>
                    <template v-if="query.category">
                    {{ categories[query.category] }} <span v-if="query.page > 1"> ➨ <?php echo e(__('main.страница')); ?> {{ query.page }}</span>
                    </template>
                    <template v-else>
                    <?php echo e(__('main.Полезная информация')); ?> <span v-if="query.page > 1"> ➨ <?php echo e(__('main.страница')); ?> {{ query.page }}</span>
                    </template>
                </h1>
...
<script src="<?php echo e(url('js/information/index.js?v=' . $version)); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', [
  'meta_title' => $meta_title? $meta_title : __('main.Полезная информация'),
  'meta_desc' => $meta_desc? $meta_desc : __('main.Полезная информация'),
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/zagorodnaz/dev.zagorodna.com/dev_app/resources/views/information/index.blade.php ENDPATH**/ ?>