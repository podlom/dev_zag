...
<div <?php echo $__env->make('crud::inc.field_wrapper_attributes', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> >
    ...
    <div class="checkbox">
        <input type="hidden" name="<?php echo e($field['name']); ?>" value="<?php echo e(old(square_brackets_to_dots($field['name'])) ?? $field['value'] ?? $field['default'] ?? 0); ?>">
          ...
          <?php endif; ?>
          <?php if(!isset($field['attributes']['id'])): ?>
              id="<?php echo e($field['name']); ?>_checkbox"
          <?php endif; ?>
          >
    	<label class="form-check-label font-weight-normal" for="<?php echo e($field['attributes']['id'] ?? $field['name'] . '_checkbox'); ?>"><?php echo $field['label']; ?></label>
...
<?php /**PATH /var/www/zagorodnaz/dev.zagorodna.com/dev_app/vendor/backpack/crud/src/resources/views/crud/fields/checkbox.blade.php ENDPATH**/ ?>