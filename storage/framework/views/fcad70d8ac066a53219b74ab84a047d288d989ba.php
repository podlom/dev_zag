    ...
    <section class="breadcrumbs">
        <div class="breadcrumbs__wrapper">
            <div class="breadcrumbs__list">
                ...
                <a href="#" class="breadcrumbs__link" v-if="query.parent_category" v-cloak>{{ parent_categories[query.parent_category] }}</a>
...
<script src="<?php echo e(url('js/business/index.js?v=' . $version)); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', [
  'meta_title' => $meta_title? $meta_title : __('main.Бизнесу'),
  'meta_desc' => $meta_desc? $meta_desc : __('main.Бизнесу'),
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/zagorodnaz/dev.zagorodna.com/dev_app/resources/views/business/index.blade.php ENDPATH**/ ?>