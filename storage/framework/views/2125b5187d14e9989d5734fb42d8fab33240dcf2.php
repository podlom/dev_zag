...
<script src="<?php echo e(url('js/servisy/index.js?v=' . $version)); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', [
  'meta_title' => $meta_title? $meta_title : __('main.Сервисы'),
  'meta_desc' => $meta_desc? $meta_desc : __('main.Сервисы'),
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/zagorodnaz/dev.zagorodna.com/dev_app/resources/views/servisy/index.blade.php ENDPATH**/ ?>