<?php if($crud->hasAccess('show')): ?>
	...
	<!-- Single edit button -->
	<a href="<?php echo e(url($crud->route.'/'.$entry->getKey().'/show')); ?>" class="btn btn-sm btn-link"><i class="fa fa-eye"></i> <?php echo e(trans('backpack::crud.preview')); ?></a>

	<?php else: ?>

	<!-- Edit button group -->
	<div class="btn-group">
	  <a href="<?php echo e(url($crud->route.'/'.$entry->getKey().'/show')); ?>" class="btn btn-sm btn-link pr-0"><i class="fa fa-eye"></i> <?php echo e(trans('backpack::crud.preview')); ?></a>
	...
	<?php endif; ?>
<?php endif; ?><?php /**PATH /var/www/zagorodnaz/dev.zagorodna.com/dev_app/vendor/backpack/crud/src/resources/views/crud/buttons/show.blade.php ENDPATH**/ ?>