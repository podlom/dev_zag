...
use App\Http\Requests\ContestArticleRequest;
...
/**
 * Class ContestArticleCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class ContestArticleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/contestarticle');
        $this->crud->setEntityNameStrings('запись', 'конкурсы');
    ...
    {
        $this->crud->setValidation(ContestArticleRequest::class);
