...
use App\Http\Requests\StatisticsArticleCategoryRequest;
...
/**
 * Class StatisticsArticleCategoryCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class StatisticsArticleCategoryCrudController extends CrudController
{
    ...
    private $ids = [194,195,375,376];
    private $parent_categories;

    public function setup()
    {
        $this->crud->setModel('Backpack\NewsCRUD\app\Models\Category');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/statisticsarticlecategory');
    ...
    {
        $this->crud->setValidation(StatisticsArticleCategoryRequest::class);
        ...
        $this->crud->addField([
            ...
            'type' => 'translation',
            'model' => 'statisticsarticlecategory',
        ]);
