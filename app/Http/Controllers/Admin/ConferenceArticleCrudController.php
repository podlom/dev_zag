...
use App\Http\Requests\ConferenceArticleRequest;
...
/**
 * Class ConferenceArticleCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class ConferenceArticleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/conferencearticle');
        $this->crud->setEntityNameStrings('запись', 'конференции');
    ...
    {
        $this->crud->setValidation(ConferenceArticleRequest::class);
