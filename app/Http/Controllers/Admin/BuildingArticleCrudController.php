...
use App\Http\Requests\BuildingArticleRequest;
...
/**
 * Class BuildingArticleCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class BuildingArticleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/buildingarticle');
    ...
    {
        $this->crud->setValidation(BuildingArticleRequest::class);
