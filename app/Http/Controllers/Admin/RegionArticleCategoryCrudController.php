...
use App\Http\Requests\RegionArticleCategoryRequest;
...
/**
 * Class RegionArticleCategoryCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class RegionArticleCategoryCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/regionarticlecategory');
    ...
    {
        $this->crud->setValidation(RegionArticleCategoryRequest::class);
