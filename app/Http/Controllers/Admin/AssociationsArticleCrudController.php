...
use App\Http\Requests\AssociationsArticleRequest;
...
/**
 * Class AssociationsArticleCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class AssociationsArticleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/associationsarticle');
        $this->crud->setEntityNameStrings('запись', 'Объединения');
    ...
    {
        $this->crud->setValidation(AssociationsArticleRequest::class);
