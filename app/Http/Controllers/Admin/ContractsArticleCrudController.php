...
use App\Http\Requests\ContractsArticleRequest;
...
/**
 * Class ContractsArticleCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class ContractsArticleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/contractsarticle');
        $this->crud->setEntityNameStrings('запись', 'Виды договоров');
    ...
    {
        $this->crud->setValidation(ContractsArticleRequest::class);
