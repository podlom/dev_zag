...
use App\Http\Requests\AnaliticsArticleRequest;
...
/**
 * Class AnaliticsArticleCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class AnaliticsArticleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/analiticsarticle');
        ...
        $this->themes = Category::has('parent')->where('language_abbr', 'ru')->whereIn('parent_id', [13,28])->orderBy('name')->pluck('name', 'id')->toArray();
    ...
    {
        $this->crud->setValidation(AnaliticsArticleRequest::class);
