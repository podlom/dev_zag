...
use App\Http\Requests\LandsArticleRequest;
...
/**
 * Class LandsArticleCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class LandsArticleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/landsarticle');
        $this->crud->setEntityNameStrings('запись', 'Земля Украины');
    ...
    {
        $this->crud->setValidation(LandsArticleRequest::class);
