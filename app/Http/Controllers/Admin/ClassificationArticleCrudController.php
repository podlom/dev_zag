...
use App\Http\Requests\ClassificationArticleRequest;
...
/**
 * Class ClassificationArticleCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class ClassificationArticleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/classificationarticle');
        $this->crud->setEntityNameStrings('запись', 'Классификация недвижимости');
    ...
    {
        $this->crud->setValidation(ClassificationArticleRequest::class);
