...
use App\Http\Requests\ServicesArticleRequest;
...
/**
 * Class ServicesArticleCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class ServicesArticleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/servicesarticle');
    ...
    {
        $this->crud->setValidation(ServicesArticleRequest::class);
