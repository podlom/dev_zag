...
use App\Http\Requests\InformationArticleRequest;
...
/**
 * Class InformationArticleCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class InformationArticleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/informationarticle');
    ...
    {
        $this->crud->setValidation(InformationArticleRequest::class);
