...
use App\Http\Requests\ExhibitionArticleRequest;
...
/**
 * Class ExhibitionArticleCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class ExhibitionArticleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/exhibitionarticle');
        $this->crud->setEntityNameStrings('запись', 'выставки');
    ...
    {
        $this->crud->setValidation(ExhibitionArticleRequest::class);
