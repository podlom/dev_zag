...
use App\Http\Requests\EcologyArticleRequest;
...
/**
 * Class EcologyArticleCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class EcologyArticleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/ecologyarticle');
    ...
    {
        $this->crud->setValidation(EcologyArticleRequest::class);
