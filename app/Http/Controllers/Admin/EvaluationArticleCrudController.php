...
use App\Http\Requests\EvaluationArticleRequest;
...
/**
 * Class EvaluationArticleCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class EvaluationArticleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/evaluationarticle');
        $this->crud->setEntityNameStrings('запись', 'Оценка недвижимости');
    ...
    {
        $this->crud->setValidation(EvaluationArticleRequest::class);
