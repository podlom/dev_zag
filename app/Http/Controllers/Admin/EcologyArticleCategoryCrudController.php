...
use App\Http\Requests\EcologyArticleCategoryRequest;
...
/**
 * Class EcologyArticleCategoryCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class EcologyArticleCategoryCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/ecologyarticlecategory');
        $this->crud->setEntityNameStrings('тему', 'темы');
    ...
    {
        $this->crud->setValidation(EcologyArticleCategoryRequest::class);
