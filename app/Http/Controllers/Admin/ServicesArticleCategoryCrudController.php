...
use App\Http\Requests\ServicesArticleCategoryRequest;
...
/**
 * Class ServicesArticleCategoryCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class ServicesArticleCategoryCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/servicesarticlecategory');
    ...
    {
        $this->crud->setValidation(ServicesArticleCategoryRequest::class);
