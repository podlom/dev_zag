...
class Builder
{
    ...
    public function firstOrWithoutScopes()
    {
        if($this->first())
            return $this->first();
    ...
    public function firstOrTranslation($path = null)
    {
        ...
        $this->withoutGlobalScope('language');
        
        if($lang === 'ru' && $this->first() && $this->first()->original) {
            header('Location: ' . $this->first()->original->link . $path);
            exit();
        }

        if($lang !== 'ru' && $this->first() && $this->first()->translations->where('language_abbr', $lang)->first()){
            header('Location: ' . $this->first()->translations->where('language_abbr', $lang)->first()->link . $path);
            exit();
        }

        // if($lang === 'ru' && $this->first()) {
        //     return $this->first()->original->link . $path;
        // }

        // if($lang !== 'ru' && $this->first() && $this->first()->translations->where('language_abbr', $lang)->first()){
        //     return $this->first()->translations->where('language_abbr', $lang)->first()->link . $path;
        // }
