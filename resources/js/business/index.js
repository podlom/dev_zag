...
const news = new Vue({
  ...
  watch: {
    'query.page': function(value) {
      ...
      location.protocol + '//' + location.host + '/' + lang + '/' + this.query.parent_category + '/' + this.query.category 
    ...
    'query.parent_category': function(value) {
      ...
      let newUrl = this.query.parent_category? location.protocol + '//' + location.host + '/' + lang + '/' + this.query.parent_category : location.protocol + '//' + location.host + '/' + lang;
  ...
  created: function(){
    console.log('business vue created');
  }
});