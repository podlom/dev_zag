    ...
    <section class="news">
        <div class="news__wrapper container">
            <div class="general-heading">
                <h1 class="main-caption-l" v-cloak>@{{ categories[query.category] }} <span v-if="query.page > 1"> ➨ {{ __('main.страница') }} @{{ query.page }}</span></h1>
...
<script src="{{ url('js/regions/index.js?v=' . $version) }}"></script>
@endpush