    ...
    <table border="0" cellpadding="0" cellspacing="0" style="margin:0 auto; padding:40px 40px 20px; max-width: 600px; width: 100%; font: 16px Arial,sans-serif; line-height: 24px; color: #3d3d3d;">
        ...
        <tr>
            <td style="font: 22px Arial,sans-serif; line-height: 24px; color: #3d3d3d; padding: 0px 0px 30px;">
                <b style="-webkit-text-size-adjust:none; font-size: 22px; margin: 0px; display: block;">Новости за эту неделю</b>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="font: 16px Arial,sans-serif; line-height: 24px; Margin: 0;margin: 0;">
                <span style=" display:inline-block; vertical-align: top; text-align: center; padding-right: 25px;">
                    <img border="0" width="180" height="90" style="max-width:180px; max-height: 90px; display:inline-block; object-fit: cover;" src="{{ $article->img }}" alt="{{ $article->title }}">
                </span>
                <a href="{{ $article->link }}" style=" display:inline-block; vertical-align: top; -webkit-text-size-adjust:none; font-size: 20px; line-height: 30px;color:#3d3d3d;text-decoration:none">
                <b>
                    {{ $article->title }}
                </b>
                </a>
        ...
        @endforeach
            <td style="Margin: 0;margin: 0;padding: 45px 0px 25px; text-align: center; font: 13px Arial,sans-serif;">
                <a href="{{ \Backpack\NewsCRUD\app\Models\Category::find([1,14])->first()->link }}" target="_blank" style="color: #ffffff; -webkit-text-size-adjust:none; text-decoration: none; text-transform: uppercase; display: inline-block; width: 270px; height: 48px; line-height: 48px; text-align: center; background-color: #7bc97b; border-radius: 6px; box-shadow: 0px 1px 6px 0px rgba(0, 0, 0, 0.08); position: relative;">
                    <b>посмотреть</b>
