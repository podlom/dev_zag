    ...
    <section class="favorite">
        <div class="favorite__wrapper container">
            <div class="general-heading">
                <h1 class="main-caption-l">{{ $page->main_title }}</h1>
            </div>
            <div class="general-tabs">
                <ul class="general-tabs__list">
                    <li class="general-tabs__item" @click="query.tab = 'cottages'" :class="{active: query.tab == 'cottages'}">{{ __('main.Коттеджи') }}</li>
                    <li class="general-tabs__item" @click="query.tab = 'newbuilds'" :class="{active: query.tab == 'newbuilds'}">{{ __('main.Новостройки') }}</li>
                    <li class="general-tabs__item" @click="query.tab = 'promotions'" :class="{active: query.tab == 'promotions'}">{{ __('main.Акции') }}</li>
                    <li class="general-tabs__item" @click="query.tab = 'companies'" :class="{active: query.tab == 'companies'}">{{ __('main.Компании') }}</li>
                    <li class="general-tabs__item" @click="query.tab = 'articles'" :class="{active: query.tab == 'articles'}">{{ __('main.Статьи') }}</li>
            ...
            <div class="main-filtration__wrapper main-filtration__wrapper-favorite">
                <ul class="general-filter__list">
                    <li class="general-filter__item">
                        ...
                        <div class="general-drop js-drop-item">
                            <button type="button" class="general-filter__button js-drop-button">
                                <input type="text" class="general-drop-input js-drop-input" :value="query.filter_1 != null? filters_1[query.filter_1] : '{{ __('main.Не выбрано') }}'" readonly="">
                                <span class="icon-drop"></span>
                            </button>
                            <div class="general-drop__wrapper">
                                <ul class="general-drop__list">
                                  <li class="general-drop__item js-drop-contains" @click="query.filter_1 = null" :class="{active: query.filter_1 == null}">{{ __('main.Не выбрано') }}</li>
                    ...
                    <li class="general-filter__item">
                        ...
                        <div class="general-drop js-drop-item">
                            <button type="button" class="general-filter__button js-drop-button">
                                <input type="text" class="general-drop-input js-drop-input" :value="query.filter_2 != null? filters_2[query.filter_2] : '{{ __('main.Не выбрано') }}'" readonly="">
                                <span class="icon-drop"></span>
                            </button>
                            <div class="general-drop__wrapper">
                                <ul class="general-drop__list">
                                  <li class="general-drop__item js-drop-contains" @click="query.filter_2 = null" :class="{active: query.filter_2 == null}">{{ __('main.Не выбрано') }}</li>
...
@push('scripts')
<script src="{{ url('js/favorite/favorite.js?v=' . $version) }}"></script>
@endpush