    ...
    <section class="breadcrumbs">
        <div class="breadcrumbs__wrapper">
            <div class="breadcrumbs__list">
                ...
                <a href="#" class="breadcrumbs__link" @click.prevent="query.category = null" v-cloak>{{ __('main.Экология') }}</a>
        ...
        <div class="news__wrapper container">
            <div class="general-heading">
                <h1 class="main-caption-l" v-cloak>
                    ...
                    <template v-else>
                        {{ __('main.Экология') }} <span v-if="query.page > 1"> ➨ {{ __('main.страница') }} @{{ query.page }}</span>
                    </template>
                </h1>
...
<script src="{{ url('js/ecology/index.js?v=' . $version) }}"></script>
@endpush